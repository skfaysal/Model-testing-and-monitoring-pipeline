...
model4 = load_model('/home/faysal/PycharmProjects/DiabeticRetnopathy/test model/models/'
                    'b5_newpreprocessed_full_fold4.h5')

model_lf = load_model('/home/faysal/PycharmProjects/DiabeticRetnopathy/test model/models/'
                      'model_binary_right_leaft_retina.h5')
# image_data
img_data__path = glob('/home/faysal/Desktop/left right/eyepacs_train/*')

# label
cs_path = pd.read_csv("/home/faysal/Desktop/processed/messidorFull.csv")

folder_path = '/home/faysal/Desktop/eyepacs_train/'

save_path = '/home/faysal/Desktop/left right/output/'
